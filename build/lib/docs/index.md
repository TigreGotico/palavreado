...
Dead-simple keyword-based intent parser for [OpenVoiceOS (OVOS)](https://openvoiceos.org) voice assistants — a drop-in replacement for [Adapt](https://github.com/MycroftAI/adapt).
...
- **Dependencies:** `simplematch`, `quebra_frases` (core); OVOS stack only required for the pipeline plugin
- **Python:** 3.9 – 3.13
- **License:** Apache 2.0
